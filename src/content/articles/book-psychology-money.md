...
投資の本は「何を買うべきか」という技術論が多いのですが、この本は「なぜ感情が判断を狂わせるのか」がテーマで、読んでいてずっと自分のことを言われているようでした。特に「人は他人の成功を見るとき、幸運の役割を過小評価する」という指摘が刺さりました。

実践したのは、投資の判断基準を一度書き出してメモしておくことです。「どんな条件になったら売るか」「何%下がったら追加投資するか」を事前に決めておくことで、感情で動くリスクを減らしました。ただ実際に相場が動くと「あのルールを変えようかな」という考えが出てきて、事前ルールを守ることの難しさを実感しました。

技術論より心理論を学びたい投資初心者、特に「なぜうまくいかないのか」を理解したい会社員に特に向いています。
