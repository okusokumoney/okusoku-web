...
「なぜインデックスファンドが良いのか」の理論的な説明をずっと探していて、読みました。バンガード創業者のボーグルが書いた本ということで、「理念の人」というより「徹底した数字の人」という印象を受けました。

実践したのは、自分の積立ファンドのコストを全部洗い出して、信託報酬の差が30年でいくらの差になるかを計算することです。年0.5%の差が30年で数百万円規模になることを実感して、ファンドのコスト見直しを徹底しました。ただ「コストが全て」という考え方に傾きすぎて、最初は極端に低コストにこだわりすぎた面もありました。

投資を始めているけれど「なぜインデックスが良いのか」の根拠が欲しい会社員に、理論的な確信を与えてくれる一冊です。
