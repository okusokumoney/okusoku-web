...
転職後も積立は継続できます。ただし転職先に企業型DC（企業型確定拠出年金）がある場合、iDeCoとの合算で拠出上限が変わるため、転職後に人事部門へiDeCoとの併用可否と上限額を確認する必要があります。確認せずに過剰に拠出していると、後で修正手続きが必要になることがあります。転職直後は掛金の変更手続きに1〜2ヶ月かかる点も考慮して、早めに動くのが得策です。

**Q. iDeCoで運用する商品はどう選べばいいですか？**
初心者には、信託報酬が低い全世界株式のインデックスファンドを選ぶのがシンプルで無難です。私もeMAXIS Slim 全世界株式（オール・カントリー）と同等の商品を選びました。「60歳まで引き出せない」という前提があるため、短期の値動きを気にせず長期で運用できる低コストのインデックスファンドが、iDeCoの特性と最も合っていると思います。

**Q. iDeCoの節税効果はどうやって確認できますか？**
年末調整または確定申告で「小規模企業共済等掛金控除」として申告した後、翌年の住民税決定通知書（6月頃に届く）と源泉徴収票の所得税額を見比べると、前年と比べて税負担が減っていることを確認できます。証券会社から10〜11月頃に「払込証明書」が届くので、それを年末調整の書類と一緒に会社に提出するだけで手続きは完了します。
