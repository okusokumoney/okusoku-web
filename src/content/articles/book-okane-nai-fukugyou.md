...
副業に興味はあるけれど「自分には特別なスキルがない」という思い込みがずっとありました。この本は「スキルゼロ・資金ゼロでも始められる」という前提で書かれていて、それだけで少し気持ちが軽くなりました。

本書の具体例を参考に、まずクラウドワークスに登録してデータ入力の案件を1件取ってみました。単価は1件200円で、1時間かけて200円でした。「これじゃ割に合わない」と感じて2週間ほどやる気を失いました。ただそこで諦めず、同じプラットフォームで少し単価の高いライティング案件に移行したら、月1〜2万円のペースになってきました。

「副業に挑戦したことがない」「自分には無理だと思っている」会社員が最初の一歩を踏み出すきっかけとして最適な本です。
